...
import StatisticsRobot from "./pages/StatisticsRobot";
import CornersRobot from "./pages/CornersRobot";
import CardsRobot from "./pages/CardsRobot";
import GoalsRobot from "./pages/GoalsRobot";
...
import AdminRobots from "./pages/AdminRobots";
...
import BrasileiraoB from "./pages/BrasileiraoB";
import LeagueHub from "./pages/LeagueHub";
import MatchCenter from "./pages/MatchCenter";
import ChatPro from "./pages/ChatPro";
import EntriesAI from "./pages/EntriesAI";
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/entries-ai" component={EntriesAI} />
      ...
      <Route path="/brasileirao-serie-b" component={BrasileiraoB} />
      <Route path="/ligas/:slug" component={LeagueHub} />
      ...
      <Route path="/admin/robots">{() => <AdminRoute component={AdminRobots} />}</Route>
      ...
      <Route path="/statistics" component={StatisticsRobot} />
      <Route path="/corners" component={CornersRobot} />
      <Route path="/cards" component={CardsRobot} />
      <Route path="/goals" component={GoalsRobot} />
